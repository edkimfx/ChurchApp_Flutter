...
class Strings {
	...
	List<String> get onboardingpagetitles => [
		'Welcome to Nezamu International Media',
		'Packed with Features',
		'Audio, Video \n and Live Streaming',
		'Create Account',
	];
	List<String> get onboardingpagehints => [
		'One Stop Media which brings you: Full Entertainment ,Life Coach program ,Educational-Youth/Parents Programs ,Spiritual Teaching programs ,Inspirational Testimonies and Interviews.',
		'We have brought together all of the top features to Nezamu Media App.',
		'Allow users across the globe watch videos, listen to audio messages and watch live streams ',
		'Start your journey .',
	];
...
class StringsEs extends Strings {
	...
	@override String get appname => 'Nezamu International Media';
